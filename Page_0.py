...
with col1:
    ...
    st.page_link("Page_1.py", label="Youtube Analysis", icon="🎈")
with col2:
    ...
    st.page_link("Page_2.py", label="PDF Analysis", icon="📄")
with col3:
    ...
    st.page_link("Page_3.py", label="URL Analysis", icon="💻")
with col4:
    ...
    st.page_link("Page_4.py", label="CSV AnalysisAnalysis", icon="📈")
with col5:
