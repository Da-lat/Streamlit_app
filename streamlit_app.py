...
flex_team_records = st.Page("Page_12.py", title="Flex Team Records", icon=":material/emoji_events:")

pg = st.navigation([home_page,yt_page, pdf_page, url_page, csv_page, text_page, video_game_covers, news, random_champ, coach_analysis, flex_combo_stats, flex_team_records])
